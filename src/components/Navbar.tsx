          ...
          <a href="#" className="flex items-center gap-2.5 shrink-0">
            ...
            <div className="leading-tight">
              <div className="font-extrabold text-sm sm:text-base tracking-tight text-white flex items-center gap-1.5">
                COWAY <span className="text-[9px] sm:text-[10px] px-1.5 py-0.5 rounded bg-sky-950 text-sky-400 font-bold border border-sky-800/60">MALAYSIA</span>
              </div>
              <div className="text-[10px] sm:text-[11px] text-slate-400 font-medium flex items-center gap-1 mt-0.5">
