        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2 space-y-3">
            ...
            <p className="text-slate-400 max-w-sm leading-relaxed">
              Laman promosi ini diuruskan oleh Ejen Jualan Sah Coway (Perancang Kesihatan: {siteConfig.agentName}, Kod HP: {siteConfig.hpCode}). Semua hak cipta, tanda dagang dan logo adalah hak milik Coway (M) Sdn Bhd.
            </p>
          </div>
          ...
          <div>
            <h4 className="text-white font-bold text-sm mb-3">Hubungi Ejen Sah</h4>
            ...
            <p>Penghantaran dan Pemasangan ke Seluruh Malaysia</p>
          </div>
        </div>
