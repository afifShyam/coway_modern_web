...
import { Facebook, ShoppingBag, Phone, MessageCircle, ShieldCheck } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-slate-300">Kod Health Planner: <strong className="text-white">{siteConfig.hpCode}</strong></p>
        ...
        {/* Brand Copyright Bar */}
        <div className="pt-8 border-t border-slate-850 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-400 text-[11px]">
